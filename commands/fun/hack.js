  ...
  run: async (client, message, args) => {
    ...
    message.channel
      ...
      .then((msg) => {
        ...
        wait(444);
        msg.edit("Injecting Neon virus into users discriminator");
        wait(555);
        ...
        wait(800);
        msg.edit("Selling data to DarkNet");
        wait(900);
        msg.edit("Reporting account to discord for breaking tos...");
        wait(400);
        msg.edit("Hacking medical records");
        wait(600);
        msg.edit(`IMPORTANT health update: ${taggedUser}'s Lung's is not found`);
        wait(500);
